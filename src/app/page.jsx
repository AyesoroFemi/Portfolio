    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I'm Femi Ayesoro, a Software Engineer, Problem-Solver, and Content Creator
            passionate about building scalable web applications and sharing knowledge.
            With expertise in full-stack development, I specialize in Golang and React.
            I enjoy creating innovative solutions, mentoring developers, and contributing to the tech ecosystem.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink href="https://x.com/ayesorofemi" aria-label="Follow on X" target="_blank" icon={XIcon} />
            <SocialLink
      ...
      <Container className="mt-24 md:mt-28">
        <div className="mx-auto grid max-w-xl grid-cols-1 gap-y-8 lg:max-w-none lg:grid-cols-2 lg:gap-8">
          ...
          <iframe
            className="w-full aspect-video"
            src="https://www.youtube.com/embed/mD-rLu0QiSs?si=cQEgfAf1PmnlRHBK"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ...
          <iframe
            className="w-full aspect-video"
            src="https://www.youtube.com/embed/W8b35pqiLZk?si=rWArO5PGjDtE1CD6"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ...
          <iframe
            className="w-full aspect-video"
            src="https://www.youtube.com/embed/cqfCILOkBIs?si=5OUrQI-cx_v1jbKQ"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
